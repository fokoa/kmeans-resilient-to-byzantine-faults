...
def main():
    ...
    # Load dataset
    path = "data/Statlog vehicule silhouette/"
    xaa = pd.read_csv(path+"xaa.dat",
                      header=None, sep='\s+');
    xab = pd.read_csv(path+"xab.dat",
                      header=None, sep='\s+');
    xac = pd.read_csv(path+"xac.dat",
                      header=None, sep='\s+');
    xad = pd.read_csv(path+"xad.dat",
                      header=None, sep='\s+');
    xae = pd.read_csv(path+"xae.dat",
                      header=None, sep='\s+');
    xaf = pd.read_csv(path+"xaf.dat",
                      header=None, sep='\s+');
    xag = pd.read_csv(path+"xag.dat",
                      header=None, sep='\s+');
    xah = pd.read_csv(path+"xah.dat",
                      header=None, sep='\s+');
    xai = pd.read_csv(path+"xai.dat",
                      header=None, sep='\s+');
    ...
    # Model
    km = KMR(n_clusters=4, n_init=1, n_iter=25, seed=SEED);
    by = KMR(n_clusters=4, n_init=1, n_iter=25, seed=SEED, n_byzantines=n_byzantines);
    co = KMR(n_clusters=4, n_init=1, n_iter=25, seed=SEED, n_byzantines=n_byzantines, correction=True);
